...
{%- block content -%}
	<div class="center">
		...
		<div class="typo-6">{{ constants.HEADER_DESC_HTML }}</div>
	...
	<div id="features" class="center">
		<h2 class="typo-4">Key Features & Benefits</h2>
		<div class="typo-6 color-flint">No matter what you read—literature, science, or poetry—our dictionaries provide deeper understanding with advanced features like smart word forms and comprehensive language support, far beyond standard built-ins.</div>
	</div>
	...
	<h2 class="center typo-4">Extra Capabilities</h2>
	<div class="typo-6 color-flint center">Discover unique tools and advanced options that take your dictionary experience even further—perfect for power users and curious readers who want more than the basics.</div>
	<div class="space-1"></div>
	<div class="more">
		<div>
	...
	<div id="buy" class="center">
		...
		<div class="typo-6 color-flint">Select your languages, pay a one-time fee, and get unlimited access to evolving dictionaries with updates at least twice a month.</div>
	</div>
	<div class="space-1"></div>
	<div class="langs">
		<div class="left">
	...
	<div id="reviews" class="center">
		...
		<div class="typo-6 color-flint">
			See what savvy readers across platforms are saying about our dictionaries.
			<br>
