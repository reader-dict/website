...
{%- block content -%}
		...
		<div class="large color-1">
			...
			<div class="screen">
                <picture>
                    ...
                    <img src="/asset/img/showcase.png?v={{ version }}" loading="lazy" alt=""/>
                </picture>
			</div>
		</div>
	...
	<div class="tab">
		<div class="icons">
			<a class="unstyled icon active" href="" onclick="return openTab(0)"><i class="ph ph-arrows-merge"></i></a>
			<a class="unstyled icon" href="" onclick="return openTab(1)"><i class="ph ph-arrows-in-cardinal""></i></a>
			<a class="unstyled icon" href="" onclick="return openTab(2)"><i class="ph ph-books"></i></a>
			<a class="unstyled icon" href="" onclick="return openTab(3)"><i class="ph ph-text-superscript"></i></a>
			<a class="unstyled icon" href="" onclick="return openTab(4)"><i class="ph ph-table"></i></a>
		</div>
	</div>
	<div class="space-2"></div>
	...
	<div class="purchase-card">
		...
		<a class="button" id="buy-link" href="#" data-cid="{{ customer_id }}" data-url="{{ constants.BUY_URL }}">Buy now</a>
	</div>
	...
	<div class="reviews">
		{% for review in reviews %}
            <div>
                <div class="stars">
                    {# TODO: handle notations like 4.8/5? #}
                    {{ '<i class="ph-fill ph-star"></i>' * review["stars"] }}
                </div>
	...
	<div class="faq">
		...
		<details name="exclusive" id="faq-groups">
			<summary class="typo-5">What about group purchases and promotions?</summary>
			<article class="typo-6"><sup><a href="#faq-groups" title="Link to this FAQ entry"><i class="ph ph-anchor-simple"></i></a></sup> Are you an institution, a teacher, or do you simply want to buy several copies? Would you like to offer coupons to your subscribers? Get in touch!</article>
		</details>
	</div>
{%- endblock -%}
